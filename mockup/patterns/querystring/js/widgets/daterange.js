define([
  ...
  return R.createClass({
    ...
    componentDidUpdate: function(){
      var that = this;
      var $input1 = $(this.refs.input1).parent().find('.pattern-pickadate-date');
      var $input2 = $(this.refs.input2).parent().find('.pattern-pickadate-date');
